...
from config import FOLDER_FATURAMENTO_ID, FOLDER_OFX_ID, FAT_DIR, FOLDER_SUBSCRIPTIONS_ID, OFX_DIR, SUBSCRIPTIONS_DIR
import os
...
class DirCheckerService:
  ...
  def __download_itens_from_dir(self, files_to_download, dir):
    file_names = []
  ...
  def create_dirs(self):
    dirs = [FAT_DIR, OFX_DIR, SUBSCRIPTIONS_DIR]
    for dir in dirs:
  ...
  def exec_check_fat_dir(self):
    ...
    self.__download_itens_from_dir(files, FAT_DIR)
